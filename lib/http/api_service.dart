...
import 'package:wanandroid/http/dio_manager.dart';
...
import 'package:wanandroid/model/hotword_result_model.dart';
import 'package:wanandroid/model/navi_model.dart';
import 'package:wanandroid/model/pretty_model.dart';
import 'package:wanandroid/model/projectlist_model.dart';
import 'package:wanandroid/model/project_tree_model.dart';
import 'package:wanandroid/model/system_tree_content_model.dart';
import 'package:wanandroid/model/system_tree_model.dart';
import 'package:wanandroid/model/user_model.dart';
import 'package:wanandroid/model/wx_article_content_model.dart';
import 'package:wanandroid/model/wx_article_title_model.dart';
import 'package:wanandroid/model/hotword_model.dart';
import 'api.dart';

class ApiService {
  void getBanner(Function callback) async {
    DioManager.shared.dio.get(Api.HOME_BANNER, options: _getOptions()).then((response) {
      callback(BannerModel(response.data));
    });
  }

  void getArticleList(Function callback, Function errorback, int _page) async {
    DioManager.shared.dio.get(Api.HOME_ARTICLE_LIST + "$_page/json", options: _getOptions()).then((response) {
  ...
  void getSystemTree(Function callback, Function errorback) async {
    DioManager.shared.dio.get(Api.SYSTEM_TREE, options: _getOptions()).then((response) {
  ...
  void getSystemTreeContent(Function callback, Function errorback, int _page, int _id) async {
    DioManager.shared.dio.get(Api.SYSTEM_TREE_CONTENT + "$_page/json?cid=$_id", options: _getOptions()).then((response) {
  ...
  void getWxList(Function callback, Function errorback) async {
    DioManager.shared.dio.get(Api.WX_LIST, options: _getOptions()).then((response) {
  ...
  void getWxArticleList(Function callback, int _id, int _page) async {
    DioManager.shared.dio.get(Api.WX_ARTICLE_LIST + "$_id/$_page/json", options: _getOptions()).then((response) {
  ...
  void getNaviList(Function callback, Function errorback) async {
    DioManager.shared.dio.get(Api.NAVI_LIST, options: _getOptions()).then((response) {
  ...
  void getProjectTree(Function callback, Function errorback) async {
    DioManager.shared.dio.get(Api.PROJECT_TREE, options: _getOptions()).then((response) {
  ...
  void getProjectList(Function callback, int _page, int _id) async {
    DioManager.shared.dio.get(Api.PROJECT_LIST + "$_page/json?cid=$_id", options: _getOptions()).then((response) {
  ...
  void getSearchHotWord(Function callback) async {
    DioManager.shared.dio.get(Api.SEARCH_HOT_WORD, options: _getOptions()).then((response) {
  ...
  void getSearchResult(Function callback, Function errorback, int _page, String _keyword) async {
    ...
    DioManager.shared.dio.post(Api.SEARCH_RESULT + "$_page/json", data: formData, options: _getOptions()).then((response) {
  ...
  void login(Function callback, String _username, String _password) async {
    ...
    DioManager.shared.dio.post(Api.USER_LOGIN, data: formData, options: _getOptions()).then((response) {
  ...
  void register(Function callback, String _username, String _password) async {
    FormData formData = new FormData.fromMap({"username": _username, "password": _password, "repassword": _password});
    DioManager.shared.dio.post(Api.USER_REGISTER, data: formData, options: null).then((response) {
  ...
  /// 获取收藏列表
  void getCollectionList(Function callback, Function errorback, int _page) async {
    DioManager.shared.dio.get(Api.COLLECTION_LIST + "$_page/json", options: _getOptions()).then((response) {
  ...
  /// 我的收藏-取消收藏
  void cancelCollection(Function callback, Function errorback, int _id, int _originId) async {
    FormData formData = new FormData.fromMap({"originId": _originId});
    DioManager.shared.dio.post(Api.CANCEL_COLLECTION + "$_id/json", data: formData, options: _getOptions()).then((response) {
  ...
  void getCommonWebsite(Function callback, Function errorback) async {
    DioManager.shared.dio.get(Api.COMMON_WEBSITE, options: _getOptions()).then((response) {
  ...
  void getPrettyGirl(Function callback, int _page) async {
    DioManager.shared.dio.get("http://gank.io/api/data/福利/10/" + "$_page").then((response) {
  ...
  void cancelWebsiteCollectionList(Function callback, int _id) async {
    ...
    DioManager.shared.dio.post(Api.CANCEL_WEBSITE_COLLECTION, data: formData, options: _getOptions()).then((response) {
      callback(BaseModel(response.data));
    });
  }
