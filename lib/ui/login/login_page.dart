...
import 'package:wanandroid/util/bubble_indication_painter.dart';
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            ...
            decoration: new BoxDecoration(
              gradient: new LinearGradient(
                  colors: [Color(0xFFffffff), Color(0xFFffffff)], begin: const FractionalOffset(0.0, 0.0), end: const FractionalOffset(1.0, 1.0), stops: [0.0, 1.0], tileMode: TileMode.clamp),
            ),
            child: Column(
  ...
  Widget _buildSignUp(BuildContext context) {
    Future<Null> _regist() async {
      ...
      if ((null != username && username.trim().length > 0) && (null != password && password.trim().length > 0) && (null != rePassword && rePassword.trim().length > 0)) {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: 10.0, bottom: 10, left: 25.0, right: 25.0),
                        child: TextField(
