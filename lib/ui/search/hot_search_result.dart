      ...
      return new InkWell(
        onTap: () {
          Navigator.of(context).push(new MaterialPageRoute(builder: (context) {
            return new WebViewPage(title: _datas[index].title.replaceAll("<em class='highlight'>", "").replaceAll("<\/em>", ""), url: _datas[index].link);
          }));
        },
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      _datas[index].title.replaceAll("<em class='highlight'>", "").replaceAll("<\/em>", ""),
                      maxLines: 2,
                      style: TextStyle(
                        fontSize: 16,
