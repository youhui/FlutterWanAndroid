...
import 'package:wanandroid/ui/search/hot_search_result.dart';
...
class SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    TextField searchField = new TextField(
      ...
      decoration: new InputDecoration(hintStyle: TextStyle(color: Colors.white), border: InputBorder.none, hintText: "搜索更多干货"),
      focusNode: focusNode,
  ...
  Widget buildChildren(List<DataListBean> children) {
    ...
    for (DataListBean item in children) {
      names.add(new InkWell(
        child: new Chip(materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, backgroundColor: Utils.getChipBgColor(item.name), label: new Text(item.name)),
        onTap: () {
          Navigator.of(context).push(new MaterialPageRoute(builder: (context) {
